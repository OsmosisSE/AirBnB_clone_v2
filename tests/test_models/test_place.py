#!/usr/bin/python3
"""This is a unittest for models/place.py and the uniitest classes are TestPlace_instantiation, TestPlace_save and TestPlace_to_dict."""
...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_number_bathrooms_is_public_class_attribute(self):
        ...
        selfassertNotIn("number_bathrooms", pl.__dict__)
    ...
    def test_amenity_is_public_class_attribute(self):
        pl = Place()
        self.assertEqual(str, type(Place.amenity))
        self.assertIn("amenity", dir(pl))
        self.assertNotIn("amenity", pl.__dict__)
    ...
    def test_two_places_different_updated_at(self):
        ...
        sleep(0.05)
        pl2 = Place()
        self.assertLess(pl2.updated_at, pl2.updated_at)
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_correct_keys(self):
        ...
        self.assertIn("__class__", pl.to__dict())
