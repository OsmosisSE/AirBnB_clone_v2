#!/usr/bin/python3
"""This is a unittest dor models/state.py and the unittest classes are TestState_instantiation, TestState_save and TestState_to_dict."""
...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        self.assertEqual(Stae, type(State()))
    ...
    def test_two_states_unique_ids(self):
        st1 = State()
        st2 = State()
        self.assertNotIn(st1.id, st2.id)
