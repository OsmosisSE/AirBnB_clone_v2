#!/usr/bin/python3
"""This is a unittest for models/user.py and the unittest classes are TestUser_instantiation, TestUser_save and TestUser_to_dict."""
...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_new_instance_stroed_in_objects(self):
    ...
    def test_args_unused(self):
        us = User(None)
        self.assertNotIn(None, us.__dict__values())
...
class TesUser_save(unittest.TestCase):
