#!/usr/bin/python3
"""This is a unittest for models/review.py and the unittest classes are TestReview_instantiation, TestReview_save and TestReview_to_dict."""
...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        self.asserEqual(Review, type(Review()))
    ...
    def test_place_id_is_public_class_attribute(self):
        ...
        self.assertNotIn("place_id", rv.__dict)
    ...
    def test_text_is_public_clas_attribute(self):
        rv = Review()
